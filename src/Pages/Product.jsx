...
// // Generates a smart page list like [1, 2, 3, '...', 9, 10]
...
//           affordability — because looking good shouldn't cost a fortune. From
//           beauty must-haves to dainty accessories, each piece is curated to
//           bring a little extra joy to your everyday routine.
//         </p>

//         <p className="text-gray-600 text-base leading-relaxed mt-4">
//           Take your time exploring our collection — and once you've found
//           something you love, we'd be delighted to hear your thoughts. Your
//           feedback helps us keep curating pieces that you'll truly adore.
//         </p>
...
//       {/* ERROR */}
//       {error && (
//         <div className="flex justify-center items-center text-center mb-6 px-6">
